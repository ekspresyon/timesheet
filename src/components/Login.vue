<!-- Contains all login for vues and scripts.
Scripts depend on ./src/store/index.js file running vuex.
!!!!Currently bugs in singup method.!!!!
-->
<template>
  <div id="login">
        ...
        <section>
            <div class="col1">
                <h1>Timesheet</h1>
                <p>Welcome to Timesheet's sample timecard management web app powered 
                	by Vue.js and Firebase.
                    This project is build to potentially provide a tailord timecard 
                    and staff management and dispatch for employees of an on-demand 
                    dispatched service company.
                </p>
            </div>
...
export default {
	data() {
            return {
		        ...
		        //other forms and messages need to be invisible on lending default:false
